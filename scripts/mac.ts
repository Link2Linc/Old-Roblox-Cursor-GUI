...
console.log = function(text: any) { // overwriting the function
  ...
  actualConsoleLog('console.log was called!'); // example additon

  // optionally if you want to preserve the behavior of console.log, finish by actually logging to the console
  actualConsoleLog(...arguments); // look up "js arguments object" and "js spread operator" if you want to learn how this works
}
